...
### MOCS (the ties)
- [[State-Not-Fate-MOC]] — Central hub for philosophy, PWA, sources, 5-year vision, evidence.
- [[AI-Systems-MOC]] — AI Life Coach Friend, David Prompt Library, Anti-Gravity integration, daily use.

### Tech (implementation & AI layer)
- [[../Tech/SNF-PWA-AntiGravity-Engine]] — Full Update 3 PWA details, Polaris, energy tiers, exact PHQ-9 language, protocols.
- [[../Tech/AI-Life-Coach-and-Prompt-Library]] — The execution OS + 12 command prompts, shared blunt principles.

### Human (personal & philosophy)
- [[../Human/SNF-Core-Philosophy]] — "State, not fate", anchors, mantras, restartability, clinical framing, your testimonial shaping the design.
...
- Start from [[State-Not-Fate-MOC]] or this log for an overview.
