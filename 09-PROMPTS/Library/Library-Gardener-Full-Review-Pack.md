...
## Skill / Protocol: master-bio
**Description:** >
**Meta:** Energy: any | Domain: [meta]
...
## Skill / Protocol: council-strategy
**Description:** >
**Meta:** Energy: medium | Domain: [meta, decision-making]
...
INSTRUCTIONS FOR THE AI OPERATOR:
1. ACT AS THE COUNCIL: Convene a virtual panel of 3ΓÇô4 specialized experts tailored to the decision (examples: Peer Recovery Supervisor, HVAC/Field Tech Master, Logistics Operations Lead, Financial Runway Planner, Social/Relationship Translator).
...
## Expert Lanes (common ones ΓÇö invent others as needed)
- /prs ΓÇö Peer Recovery lens (safety, energy floor, shame avoidance, clinical realism)
- /tech ΓÇö Field/technical trades lens (apprenticeship reality, tools, physical sustainability)
- /ops ΓÇö Logistics/warehouse/driver lens (throughput, schedule reliability, body management)
- /coach ΓÇö Execution + job search operator lens (volume, tailoring, follow-up systems)

## Related
- thoroughness-protocol ΓÇö Almost always prefix /council with /tp
...
**Description:** >
**Meta:** Energy: low | Domain: [recovery, execution]
...
- Library Gardener pass 2026-06-13: Fixed domain compliance (removed non-Dictionary 'low-energy' from domain; now [recovery, execution] + tags). Validated clean. Included in full review packs, Daily/Favorites, low-energy cluster emit. All emitter tests passed cleanly post-edit. Synced to .grok/skills/ and pushed to GitHub. Cross-refs to mvd-anchors, snf-proof-registration, sobriety-anchors confirmed. No further content edits.
...
**Description:** >
**Meta:** Energy: low | Domain: [execution]
...
**Description:** >
**Meta:** Energy: low | Domain: [prs, recovery, health]
