...
description: >
  Design and maintain parallel career tracks (PRS + trades like HVAC/maintenance) aligned to 5-year vision while respecting current runway, energy variability, and recovery floor. Produce milestones, decision criteria, and low-friction moves that build proof without over-committing on any single day.
domain: [career, job, philosophy-snf]
energy: medium
invocation: ["/career", "career strategy", "5 year plan", "parallel tracks PRS HVAC"]
compatible_with: [grok, claude, gpt, local, all]
version: 1
last_reviewed: 2026-06-12
tags: [career, job, 5-year-vision, prs-track, hvac, career-planning, state-not-fate, systems]
---
