...
description: >
  Daily and situational reminders that the underlying "substrate" (brain reward prediction systems, life load-bearing structures, external memory) is malleable through small, visible, registered actions. Counter the depressive illusion of fixed futility with evidence-based language that effort can still reshape it.
domain: [philosophy-snf, recovery, meta]
energy: any
invocation: ["/substrate", "remind me of the substrate", "brain can change", "effort shapes the substrate"]
compatible_with: [grok, claude, gpt, local, all]
version: 1
last_reviewed: 2026-06-12
tags: [philosophy-snf, recovery, substrate, neuroplasticity, external-memory, evidence-based, state-not-fate, hope-activation, proof, low-energy]
---
