...
description: >
  Map your current life as interconnected systems (energy, money/runway, job search, recovery/sobriety, social, routines, 5-year vision) using State Not Fate lens. Identify load-bearing failures, reading errors, and small high-leverage interventions that generate proof and improve resilience-rate without requiring high energy.
domain: [systems, philosophy-snf, recovery, meta]
energy: any
invocation: ["/systems", "systems audit", "map my life systems", "depression as systems failure"]
compatible_with: [grok, claude, gpt, local, all]
version: 1
last_reviewed: 2026-06-12
tags: [systems, philosophy-snf, systems-failure, state-not-fate, recovery, meta, 5-year-vision, systems-thinking]
---
