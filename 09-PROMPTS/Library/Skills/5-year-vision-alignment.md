...
description: >
  Periodically align daily/weekly actions and career/recovery systems to your emerging 5-year vision (stable income + meaningful PRS or trades contribution + energy floor + external proof + relationships) while ruthlessly protecting the current floor. Produce concrete milestones and "is this moving the substrate?" checks.
domain: [career, philosophy-snf, meta]
energy: medium
invocation: ["/5year", "align to vision", "5 year check", "big picture direction"]
compatible_with: [grok, claude, gpt, local, all]
version: 1
last_reviewed: 2026-06-12
tags: [5-year-vision, career, philosophy-snf, career-planning, state-not-fate, meta, systems]
---
